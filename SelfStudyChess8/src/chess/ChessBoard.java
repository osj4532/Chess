...
public class ChessBoard {
	...
	private static void setup() {
			...
			board[2][5] = new Pawn("black", 2, 5);
			
			board[3][3] = new Pawn("black", 3, 3);
			board[3][4] = new Pawn("black", 3, 4);
			board[3][5] = new Pawn("black", 3, 5);
			board[4][3] = new Pawn("white", 4, 3);
			board[4][4] = new Knight("white", 4, 4);
			board[4][5] = new Pawn("black", 4, 5);
			
			board[5][2] = new Pawn("white", 5, 2);
			
			board[5][3] = new Pawn("white", 5, 3);
			board[5][4] = new Pawn("white", 5, 4);
	...
	public static void main(String[] args) {			
		...
		System.out.println(board[4][4].movePathCheck());
